 ...
 */
@Component
public class D4I6CalculationStrategy extends AbstractIndicatorCalculationStrategy {
    ...
    public BigDecimal calculate(Map<String, Object> basicData, String cityName, Integer year) {
        ...
        // 步骤1: 从basicData中获取需要的字段
         BigDecimal freightVolume = getValue(basicData, "freight_volume");
        ...
        // 步骤3: 计算
         BigDecimal result = freightVolume;
